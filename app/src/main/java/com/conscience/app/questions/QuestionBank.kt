...
object QuestionBank {
    ...
    private val QUESTIONS = listOf(
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "I genuinely can't remember" to "Instagram didn't steal your focus overnight.\nIt took it one scroll at a time. Every single day."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "I struggle to focus on anything for more than a few minutes" to
                    "That difficulty was engineered.\nBy this app.\nAnd you keep feeding it."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "None at all" to "Hours of your life last week.\nGone.\nNothing to show for it.\nNot even a memory."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                ...
                "Patience with boredom",
                "Original creative thinking",
                "All of them — and that tells you everything"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Think, observe, or just be present",
                "Read or listen to something",
                "Reach for my phone automatically",
                "Open Instagram before I've even decided to"
            ),
            avoidantOptions = listOf("Open Instagram before I've even decided to"),
            punishmentMap = mapOf(
                "Open Instagram before I've even decided to" to
        ...
        Question(
            ...
            options = listOf(
                "Yes, easily",
                "Probably yes with some effort",
                "It would be genuinely uncomfortable",
                "No — I don't think I can"
            ),
            avoidantOptions = listOf("No — I don't think I can"),
            punishmentMap = mapOf(
                "No — I don't think I can" to
                    "5 minutes of silence is unbearable to you now.\nThis app trained that.\nYou paid for the training with your peace of mind."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Rarely — when I decide to",
                "A few times a day",
                "Constantly throughout the day",
                "I've lost count — it's automatic"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Walking or in nature",
                "In the shower or quiet space",
                "Reading or thinking",
                "I struggle to remember the last original idea I had"
            ),
            avoidantOptions = listOf("I struggle to remember the last original idea I had"),
            punishmentMap = mapOf(
                "I struggle to remember the last original idea I had" to
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "Less than 20 minutes" to
                    "A human mind can naturally focus for 90+ minutes.\nYours has been trained down to under 20.\nThis is what that looks like."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "I sit with it — boredom doesn't scare me",
                "I find something productive to do",
                "I immediately reach for my phone",
                "Boredom feels intolerable and I'll do anything to escape it"
            ),
            avoidantOptions = listOf("Boredom feels intolerable and I'll do anything to escape it"),
            punishmentMap = mapOf(
                "Boredom feels intolerable and I'll do anything to escape it" to
                    "Boredom intolerance is a symptom.\nInstagram is the cause.\nYou trained yourself to need constant stimulation.\nNow silence feels like pain."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "I can hold the thought and go deep",
                "I can focus but it takes effort",
                "My mind drifts quickly to other things",
                "I find it genuinely hard to think without distraction"
            ),
            avoidantOptions = listOf("I find it genuinely hard to think without distraction"),
            punishmentMap = mapOf(
                "I find it genuinely hard to think without distraction" to
                    "The ability to think clearly is the foundation of everything.\nYou are eroding yours.\nOne scroll at a time."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "A lot — it's genuinely useful",
                "Some things occasionally",
                "Very little honestly",
                "Almost nothing — it's mostly entertainment I forget"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Read, write, or create more",
                "Have deeper conversations",
                "Build something I keep putting off",
                "Honestly I'm not sure anymore — and that scares me"
            ),
            avoidantOptions = listOf("Honestly I'm not sure anymore — and that scares me"),
            punishmentMap = mapOf(
                "Honestly I'm not sure anymore — and that scares me" to
                    "When you don't know who you are without the feed,\nthe feed has already become you."
            )
        ),

        // === CATEGORY 2: TIME ACCOUNTABILITY ===
        Question(
            id = "time_1",
            category = "Time Accountability",
            text = "Name one thing you planned to do today that still isn't done.",
            options = listOf(
                "Nothing — I'm fully on top of things",
                "One small thing I'll do right after",
                "Something important I keep postponing",
                "Multiple things I've been avoiding for days"
            ),
            avoidantOptions = listOf("Multiple things I've been avoiding for days", "Something important I keep postponing"),
            punishmentMap = mapOf(
                "Multiple things I've been avoiding for days" to
                    "Instagram is where you go to avoid your life.\nYour list is still waiting.\nIt doesn't shrink while you scroll.",
                "Something important I keep postponing" to
                    "Every day you postpone it, it gets heavier.\nInstagram makes the postponing easier.\nThat's not comfort. That's debt."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "That's fine — it's how I unwind",
                "That seems high but I don't think about it",
                "That number genuinely disturbs me",
                "I already knew and I feel trapped by it"
            ),
            avoidantOptions = listOf("That seems high but I don't think about it"),
            punishmentMap = mapOf(
                "That seems high but I don't think about it" to
                    "Not thinking about it is the strategy.\nInstagram profits from exactly that.",
                "I already knew and I feel trapped by it" to
                    "Knowing and feeling trapped is the design.\nYou're not weak for feeling this.\nBut staying is a choice."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "'I wish you'd used that time differently'" to "You already know how this story ends.\nYou're writing it right now."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "I genuinely don't know — I stopped counting" to
                    "When you can't count how many times you've done something,\nit's no longer a choice.\nIt's a compulsion."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Exactly this — I needed a break",
                "Something creative or skill-building",
                "Connecting with someone I care about",
                "Working on something I keep putting off"
            ),
            avoidantOptions = listOf("Working on something I keep putting off"),
            punishmentMap = mapOf(
                "Working on something I keep putting off" to "You just answered your own question.\nAnd then kept scrolling."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Mostly intentional — I choose when and how long",
                "About half and half",
                "Mostly it just happens",
                "Almost none of it is a real decision"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                ...
                "3-7 hours",
                "7-14 hours",
                "Over 14 hours — more than a part-time job"
            ),
            avoidantOptions = listOf("Over 14 hours — more than a part-time job"),
            punishmentMap = mapOf(
                "Over 14 hours — more than a part-time job" to
        ...
        Question(
            ...
            options = listOf(
                "Something meaningful — I earned this",
                "A few small things",
                "Honestly not much",
                "Nothing — this was the first thing I did"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "No — my usage is pretty consistent",
                "Sometimes, when I notice it",
                "Yes — it's often avoidance",
                "Yes — and I often don't realize it until after"
            ),
            avoidantOptions = listOf("Yes — and I often don't realize it until after"),
            punishmentMap = mapOf(
                "Yes — and I often don't realize it until after" to
                    "When you use something to escape without knowing you're escaping,\nit has become your default coping mechanism.\nThat's a problem bigger than Instagram."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "It's usually the first thing I do" to
                    "The first thought of your day is yours.\nYou're giving it to an algorithm.\nEvery single morning."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Today",
                "This week",
                "I do things without thinking about sharing",
                "I struggle to do things without thinking about how they'd look"
            ),
            avoidantOptions = listOf("I struggle to do things without thinking about how they'd look"),
            punishmentMap = mapOf(
                "I struggle to do things without thinking about how they'd look" to
                    "When you start living for the documentation,\nyou stop living the moment.\nInstagram colonized your present tense."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "In person recently",
                "Online but meaningful",
                "I struggle to remember a genuinely good conversation",
                "I get most of my social connection through screens now"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Feel it fully and share with someone physically near you",
                "Call or message someone specific",
                "Think about whether to post it",
                "Reach for Instagram immediately"
            ),
            avoidantOptions = listOf("Reach for Instagram immediately"),
            punishmentMap = mapOf(
                "Reach for Instagram immediately" to
        ...
        Question(
            ...
            options = listOf(
                "Never — people get my full attention",
                "Rarely — only if something urgent",
                "Sometimes — I drift without meaning to",
                "Often — it's just how everyone is now"
            ),
            avoidantOptions = listOf("Often — it's just how everyone is now"),
            punishmentMap = mapOf(
                "Often — it's just how everyone is now" to
                    "'Everyone does it' is how we normalize damage.\nThe people who love you notice.\nEven if they don't say so."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "On the food and whoever I'm with",
                "Mostly present but phone nearby",
                "Phone on the table and I check it",
                "I'm usually scrolling while eating"
            ),
            avoidantOptions = listOf("I'm usually scrolling while eating"),
            punishmentMap = mapOf(
                "I'm usually scrolling while eating" to
                    "Eating is one of life's simple pleasures.\nYou've turned it into a multitasking session.\nFor what?"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Many — I have real connections here",
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "I don't really do that" to
                    "The outside world is not optional content.\nIt's where your actual life is."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Yes — we talk often and deeply",
                "Somewhat — the surface stuff",
                "Less than I should",
                "I know more about strangers on Instagram than people near me"
            ),
            avoidantOptions = listOf("I know more about strangers on Instagram than people near me"),
            punishmentMap = mapOf(
                "I know more about strangers on Instagram than people near me" to
                    "The relationships that will carry you through hard times\nare the ones you're currently neglecting\nto watch strangers live their lives."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Very present — I'm here for my life",
                "Mostly present with some drift",
                "Often somewhere else mentally",
                "I feel like I'm watching my life more than living it"
            ),
            avoidantOptions = listOf("I feel like I'm watching my life more than living it"),
            punishmentMap = mapOf(
                "I feel like I'm watching my life more than living it" to
        ...
        Question(
            ...
            options = listOf(
                "Something creative or physical",
                "A real conversation with someone",
                "Being in nature or a quiet space",
                "I struggle to remember the last time I felt genuinely content"
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "No — I'm secure in my own life",
                "Occasionally but I shake it off",
                "Yes — it affects how I feel about my own life",
                "Yes — constantly, it's exhausting"
            ),
            avoidantOptions = listOf("Yes — constantly, it's exhausting"),
            punishmentMap = mapOf(
                "Yes — constantly, it's exhausting" to
                    "FOMO was invented and is maintained by this app.\nYou are paying for the disease\nwith the currency of your peace of mind."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Nothing — this is genuinely my downtime",
                "The weather, sounds, beauty of the world",
                "A person who could use my attention",
                "My own body — tension, hunger, tiredness I haven't noticed"
            ),
            avoidantOptions = listOf("A person who could use my attention"),
            punishmentMap = mapOf(
                "A person who could use my attention" to
                    "That person will remember whether you were present.\nInstagram will not."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Not at all — it's separate from who I am",
                "A little",
                "More than I'd like to admit",
                "Significantly — I feel worse when I don't post or get engagement"
            ),
            avoidantOptions = listOf("Significantly — I feel worse when I don't post or get engagement"),
            punishmentMap = mapOf(
                "Significantly — I feel worse when I don't post or get engagement" to
                    "Your worth existed before Instagram.\nIt will exist after Instagram.\nBut this app has convinced you otherwise."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Yes — I was genuinely resting",
                "Maybe — it wasn't hurting anything",
                "No — I'd wish I'd used the time differently",
                "No — and I already know this but keep doing it"
            ),
            avoidantOptions = listOf("No — and I already know this but keep doing it"),
            punishmentMap = mapOf(
                "No — and I already know this but keep doing it" to
                    "Knowing and not changing is the most painful place to be.\nYou don't have to stay there."
            )
        ),

        // === CATEGORY 4: GOAL CONFRONTATION ===
        Question(
            id = "goal_1",
            category = "Goal Confrontation",
            text = "The most honest reason you opened Instagram just now:",
            options = listOf(
                "Genuine intentional break — I earned it",
                "Bored and this fills it temporarily",
                "Lonely and this is easier than real connection",
                "Avoiding something specific I don't want to face"
            ),
            avoidantOptions = listOf("Avoiding something specific I don't want to face", "Lonely and this is easier than real connection"),
            punishmentMap = mapOf(
                "Avoiding something specific I don't want to face" to
                    "It'll still be there when you close this.\nBigger now than before.\nInstagram didn't solve it. It just delayed you.",
                "Lonely and this is easier than real connection" to
                    "This app simulates connection without providing it.\nYou're drinking salt water for thirst.\nIt makes it worse."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "I actually started — this is earned rest",
                "A few days — I'll really start this week",
                "A few months",
                "Over a year"
            ),
        ...
        Question(
            ...
            options = listOf(
                "Actively working on it daily",
                "Making progress, not as fast as I'd like",
                "Thinking about it more than acting on it",
                "Instagram knows more about my goals than my actions do"
            ),
            avoidantOptions = listOf("Instagram knows more about my goals than my actions do"),
            punishmentMap = mapOf(
                "Instagram knows more about my goals than my actions do" to
                    "You've been consuming the life you want\nrather than building it."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "A new skill at an intermediate level",
                "The first draft of something creative",
                "A significantly healthier body",
                "I'd rather not calculate that — it would be too confronting"
            ),
            avoidantOptions = listOf("I'd rather not calculate that — it would be too confronting"),
            punishmentMap = mapOf(
                "I'd rather not calculate that — it would be too confronting" to
                    "The answer exists whether you calculate it or not.\nNot looking doesn't make it smaller."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "I've worked hard — I deserve a break",
                "It's just a few minutes",
                "I'll get to my stuff right after",
                "I'm not thinking about it — I just opened it"
            ),
            avoidantOptions = listOf("I'll get to my stuff right after", "I'm not thinking about it — I just opened it"),
            punishmentMap = mapOf(
                "I'll get to my stuff right after" to
                    "'Right after' is the most expensive phrase in the language.\nYou've said it thousands of times.",
                "I'm not thinking about it — I just opened it" to
                    "The most dangerous habit is the one that doesn't feel like a choice."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Yes — this is a genuine rest moment in a productive day",
                "Partially — I'm making some progress",
                "Not really — I know what I should be doing",
                "No — and this app is part of why not"
            ),
            avoidantOptions = listOf("No — and this app is part of why not"),
            punishmentMap = mapOf(
                "No — and this app is part of why not" to
        ...
        Question(
            ...
            options = listOf(
                "Significant progress on my main goal",
                "Complete something I've never finished",
                "Build a skill that changes my opportunities",
                "I don't know — and that uncertainty scares me"
            ),
            avoidantOptions = listOf("I don't know — and that uncertainty scares me"),
            punishmentMap = mapOf(
                "I don't know — and that uncertainty scares me" to
                    "Not knowing what you'd do without Instagram\nis a sign of how much space it occupies.\nIt has replaced your ambitions with its own."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Often — it regularly motivates real change",
                "Sometimes — occasional sparks",
                "Rarely — it's mostly passive consumption",
                "Never — inspiration here dies the moment I close the app"
            ),
            avoidantOptions = listOf("Never — inspiration here dies the moment I close the app"),
            punishmentMap = mapOf(
                "Never — inspiration here dies the moment I close the app" to
        ...
        Question(
            ...
            options = listOf(
                ...
                "A skill or career achievement",
                "My relationships and presence",
                "Honestly — the same things I wanted to change a year ago"
            ),
            avoidantOptions = listOf("Honestly — the same things I wanted to change a year ago"),
            punishmentMap = mapOf(
                "Honestly — the same things I wanted to change a year ago" to
                    "Another year of the same answer.\nInstagram also had another great year.\nThis is not a coincidence."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                ...
                "Somewhere between decision and habit",
                "Honestly my hand did it",
                "I don't even remember opening it"
            ),
            avoidantOptions = listOf("I don't even remember opening it", "Honestly my hand did it"),
            punishmentMap = mapOf(
                "I don't even remember opening it" to
                    "You lost time before you even started counting.\nThat's not using an app.\nThat's being used by one.",
                "Honestly my hand did it" to
                    "Your body has learned to do this without asking your mind.\nThat is a trained compulsion."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "They'd understand — rest is important",
                "They'd be neutral",
                "They'd be gently disappointed",
                "They'd be blunt about what they see"
            ),
            avoidantOptions = listOf("They'd be blunt about what they see"),
            punishmentMap = mapOf(
                "They'd be blunt about what they see" to
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "Too many to count honestly" to
                    "Each unfinished thing represents a version of you that started but didn't continue.\nInstagram is very good at interrupting that continuation."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Yes — I'm genuinely on track",
                "Mostly — with room to improve",
                "No — but I'm working on it",
                "No — and I spend a lot of time here instead of fixing that"
            ),
            avoidantOptions = listOf("No — and I spend a lot of time here instead of fixing that"),
            punishmentMap = mapOf(
                "No — and I spend a lot of time here instead of fixing that" to
                    "You just described the trap perfectly.\nNow close this app."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "The same things I do now — it's balanced",
                "Read and learn more",
                "Built something I care about",
                "Become a meaningfully different version of myself"
            ),
            avoidantOptions = listOf("Become a meaningfully different version of myself"),
            punishmentMap = mapOf(
                "Become a meaningfully different version of myself" to
        ...
        Question(
            ...
            options = listOf(
                "Positive — genuinely inspired",
                "Neutral — unaffected",
                "Occasionally inadequate",
                "Worse about myself but I keep coming back"
            ),
            avoidantOptions = listOf("Worse about myself but I keep coming back"),
            punishmentMap = mapOf(
                "Worse about myself but I keep coming back" to
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "Lower than before I started" to
                    "You are using something that makes you feel worse.\nRepeatedly.\nWith full knowledge.\nThat is what dependency looks like."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "No — I'm secure in who I am",
                "Occasionally but it doesn't affect me much",
                "Yes — it affects how I feel about my life",
                "Constantly — it's exhausting"
            ),
            avoidantOptions = listOf("Constantly — it's exhausting"),
            punishmentMap = mapOf(
                "Constantly — it's exhausting" to
                    "Every comparison is between your full reality\nand someone else's curated highlight.\nYou are always going to lose that comparison.\nIt was designed that way."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                ...
                "Significantly more anxious — I know this but struggle to stop"
            ),
            avoidantOptions = listOf("Significantly more anxious — I know this but struggle to stop"),
            punishmentMap = mapOf(
                "Significantly more anxious — I know this but struggle to stop" to
                    "Using something that causes you anxiety to relieve anxiety\nis one of the cruelest loops a person can be in."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Often — I have a stable baseline of contentment",
                "Sometimes",
                "Rarely",
                "Almost never — I need constant input to feel okay"
            ),
            avoidantOptions = listOf("Almost never — I need constant input to feel okay"),
            punishmentMap = mapOf(
                "Almost never — I need constant input to feel okay" to
                    "The inability to feel okay without stimulation\nis a symptom, not a personality trait.\nIt can be reversed.\nBut not while you're here."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "No — I'm completely detached from metrics",
                "Slightly",
                "More than I'd like to admit",
                "Yes — good engagement genuinely lifts my day, poor engagement ruins it"
            ),
            avoidantOptions = listOf("Yes — good engagement genuinely lifts my day, poor engagement ruins it"),
            punishmentMap = mapOf(
                "Yes — good engagement genuinely lifts my day, poor engagement ruins it" to
                    "You have handed strangers the remote control to your mood.\nAnd they don't know you exist."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "It genuinely helps and lifts my mood",
                "Mixed — sometimes one, sometimes the other",
                "It usually makes me feel worse",
                "It numbs it temporarily but the feeling is bigger after"
            ),
            avoidantOptions = listOf("It numbs it temporarily but the feeling is bigger after"),
            punishmentMap = mapOf(
                "It numbs it temporarily but the feeling is bigger after" to
                    "Numbing a feeling doesn't process it.\nIt stores it with interest.\nIt will be there when you come back."
            )
        ),
        ...
        Question(
            ...
            punishmentMap = mapOf(
                "Often — more than I'm comfortable admitting" to
                    "Envy is energy that could fuel your own growth.\nInstead you're feeding it to an algorithm\nthat uses it to keep you scrolling."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Healthy — I'm in control of it",
                "Complicated — it has more power than I'd like",
                "Dependent — I reach for it without thinking",
                "I know it's hurting me but I can't seem to stop"
            ),
            avoidantOptions = listOf("I know it's hurting me but I can't seem to stop"),
            punishmentMap = mapOf(
                "I know it's hurting me but I can't seem to stop" to
                    "That sentence describes every addiction.\nNaming it is the first step.\nThis app has to stop being the last step."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                ...
                "Mostly in control with some drift",
                "It pulls me more than I pull it",
                "Honestly — it controls me more than I control it"
            ),
            avoidantOptions = listOf("Honestly — it controls me more than I control it"),
            punishmentMap = mapOf(
                "Honestly — it controls me more than I control it" to
                    "A billion-dollar company's product controls your daily behavior.\nAnd it costs them nothing.\nYou pay with everything."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Nothing — it's normal and fine",
                "I'd have no judgment",
                "I'd feel mild concern for them",
                "I'd honestly be worried about them"
            ),
            avoidantOptions = listOf("I'd honestly be worried about them"),
            punishmentMap = mapOf(
                "I'd honestly be worried about them" to "You just described yourself.\nYou deserve the same concern."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "No — I've never needed to try",
                "I've cut back successfully",
                "I've tried and mostly failed",
                "I've tried many times and always end up back here"
            ),
            avoidantOptions = listOf("I've tried many times and always end up back here"),
            punishmentMap = mapOf(
                "I've tried many times and always end up back here" to
                    "Trying and failing repeatedly isn't weakness.\nIt's you fighting a system specifically designed to defeat you.\nYou need a different approach. Not more willpower."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "A useful tool I used intentionally",
                "A minor background thing",
                "Honestly — a smaller role than it's playing now",
                "I hope it's something I moved past"
            ),
            avoidantOptions = listOf("I hope it's something I moved past"),
            punishmentMap = mapOf(
                "I hope it's something I moved past" to "That future requires decisions made now.\nStarting with this one."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Something physical — walk, stretch, move",
                "Something creative or educational",
                "Connect with a real person",
                "I'm not sure — and that gap is the problem"
            ),
            avoidantOptions = listOf("I'm not sure — and that gap is the problem"),
            punishmentMap = mapOf(
                "I'm not sure — and that gap is the problem" to
                    "Instagram has filled so much space\nthat you don't know what would be there without it.\nFinding out is urgent."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Relief",
                "Fine — I'd adjust quickly",
                "Anxious about losing connection",
                "Genuine panic or distress"
            ),
            avoidantOptions = listOf("Genuine panic or distress"),
            punishmentMap = mapOf(
                "Genuine panic or distress" to
                    "The degree of distress at losing an app\nis the degree to which it owns you."
            )
        ),
        ...
        Question(
            ...
            options = listOf(
                "Yes — completely authentic in both",
                "Mostly the same with minor differences",
                "I curate quite a different version of myself online",
                "I don't fully know who I am offline anymore"
            ),
            avoidantOptions = listOf("I don't fully know who I am offline anymore"),
            punishmentMap = mapOf(
                "I don't fully know who I am offline anymore" to
                    "The offline version of you is the real one.\nThe one that needs food, sleep, love, and purpose.\nThat person has been waiting for you to come back."
            )
        )
    )

    private val REALITY_CHECK_QUOTES = listOf(
